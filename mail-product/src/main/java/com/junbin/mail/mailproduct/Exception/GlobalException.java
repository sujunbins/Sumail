package com.junbin.mail.mailproduct.Exception;
...
/**
 * @ Author     ：苏俊滨
 * @ Date       ：Created in 16:21 2022/8/15
 * @ Description：集中处理所有contorller抛出的异常
 **/
@Slf4j
@RestControllerAdvice(basePackages = "com.junbin.mail.mailproduct.controller")
