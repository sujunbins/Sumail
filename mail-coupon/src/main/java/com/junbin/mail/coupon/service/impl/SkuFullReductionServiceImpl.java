package com.junbin.mail.coupon.service.impl;

import com.junbin.common.to.MemberPrice;
...
import com.junbin.mail.coupon.service.MemberPriceService;
import com.junbin.mail.coupon.service.SkuLadderService;
...
import com.junbin.mail.coupon.dao.SkuFullReductionDao;
import com.junbin.mail.coupon.entity.SkuFullReductionEntity;
import com.junbin.mail.coupon.service.SkuFullReductionService;
...
public class SkuFullReductionServiceImpl extends ServiceImpl<SkuFullReductionDao, SkuFullReductionEntity> implements SkuFullReductionService {
    ...
    public void saveSkuReduction(SkuReductionTo skuReductionTo) {
        ...
        //1、保存满减打折、会员价
        //1、1）、sku的优惠、满减等信息：mall_sms--->sms_sku_ladder、sms_sku_full_reduction、sms_member_price
